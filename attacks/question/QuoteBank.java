...
public class QuoteBank {
    ...
    private static final Map<Subject, String> bossVictory;
    ...
    static {
        ...
        bossVictory = new HashMap<>();
        bossDefeat = new HashMap<>();

        bossVictory.put(Subject.CALCULUS_I, "Your efforts approached zero, but never quite reached a passing grade.");
        bossDefeat.put(Subject.CALCULUS_I, "The one failing is me, I suppose...");

        bossVictory.put(Subject.PHYSICS_I, "For every action, there is an equal and opposite rejection of your progress!");
        bossDefeat.put(Subject.PHYSICS_I, "I should have stayed under the tree...");

        bossVictory.put(Subject.CALCULUS_II, "You thought you were halfway there, but you'll never actually arrive at the end!");
        bossDefeat.put(Subject.CALCULUS_II, "A paradox! I was defeated, yet... logically, I am still standing.");

        bossVictory.put(Subject.PHYSICS_II, "Your energy is no longer yours—it belongs to the FIELD! Our potential is equalized!");
        bossDefeat.put(Subject.PHYSICS_II, "The resistance was higher than anticipated. We will comeback.");

        bossVictory.put(Subject.COMP_PROG, "As expected of you, struggling on something so simple.");
        bossDefeat.put(Subject.COMP_PROG, "Fine. I'll retire to the standard library. Your code is... readable enough.");

        bossVictory.put(Subject.ADV_COMP_PROG, "It worked on my machine. Sounds like a skill issue in your virtual machine.");
        bossDefeat.put(Subject.ADV_COMP_PROG, "Time to fly away...");

        bossVictory.put(Subject.PROB_STAT_DATA, "You are three standard deviations away from being a threat. Simply an outlier.");
    ...
    public static String getBossVictory(Subject subject) {
        return bossVictory.getOrDefault(subject, "Class dismissed.");
    }
