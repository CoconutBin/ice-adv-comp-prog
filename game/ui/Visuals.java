...
public class Visuals {
    ...
    ioHandler.print(TerminalColor.RED.apply(
        "  /██████  /██   /██ /██████ /████████        /██████  /██        /██████  /██     /██ /████████ /███████ "));
    ioHandler.print(TerminalColor.ORANGE.apply(
        " /██__  ██| ██  | ██|_  ██_/|_____ ██        /██__  ██| ██       /██__  ██|  ██   /██/| ██_____/| ██__  ██"));
    ioHandler.print(TerminalColor.YELLOW.apply(
        "| ██  \\ ██| ██  | ██  | ██       /██/       | ██  \\__/| ██      | ██  \\ ██ \\  ██ /██/ | ██      | ██  \\ ██"));
    ioHandler.print(TerminalColor.GREEN.apply(
        "| ██  | ██| ██  | ██  | ██      /██/        |  ██████ | ██      | ████████  \\  ████/  | █████   | ███████/ "));
    ioHandler.print(TerminalColor.CYAN.apply(
        "| ██  | ██| ██  | ██  | ██     /██/         \\____  ██ | ██      | ██__  ██   \\  ██/   | ██      | ██  \\ ██"));
    ioHandler.print(TerminalColor.BLUE.apply(
        "| ██/██ ██| ██  | ██  | ██    /██/          /██  \\ ██ | ██      | ██  | ██    | ██    | ██      | ██  \\ ██"));
    ioHandler.print(TerminalColor.PURPLE.apply(
        "|  ██████/|  ██████/ /██████ /████████      |  ██████/| ████████| ██  | ██    | ██    | ████████| ██  | ██"));
    ioHandler.print(TerminalColor.PINK.apply(
        " \\____ ███ \\______/ |______/|________/       \\______/ |________/|__/  |__/    |__/    |________/|__/  |__/"));

    ioHandler.printTyping("\n                      - Press Enter to start -\n");
}

    public void playPrologue(Player player, Boss boss) {
    ...
    public void showDefeat(Player player, Boss boss) {
        ...
        ioHandler.printTyping(TerminalColor.RED.apply(" [X] YOUR GPA IS CURRENTLY F! GITGUD"));
        ioHandler.printTyping(TerminalColor.RESET + boss.getName() + " is handing you a flyer for a career in competitive grass touching.");
        ioHandler.wait(500);
